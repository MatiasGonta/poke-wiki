...
const Header = () => {
    return (
        <header className="w-full bg-poke-tertiary py-4 px-6 min-[1200px]:px-0">
            <div className="size-full max-w-wrapper mx-auto flex justify-between items-center">
                <Link role="link" to="/" className="flex gap-3 items-center">
                    ...
                    <h1 role="heading" className="font-bold text-[25px] w-fit inline">Poke Wiki</h1>
                </Link>
