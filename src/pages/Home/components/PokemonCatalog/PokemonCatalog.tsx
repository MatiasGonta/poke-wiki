                ...
                ? (
                    ...
                    <>
                        ...
                        <div className="mx-auto w-fit">
                            ...
                            >
                                <ul role="list" className="min-h-[700px] grid grid-cols-1 grid-rows-auto gap-4 min-[850px]:grid-cols-2 xl:grid-cols-3">
                                    {
...
const PokemonCatalogSkeleton = () => (
    <div className="mx-auto" role="progressbar">
        <ul role="list" className="mx-auto w-auto max-w-[375px] min-h-[700px] grid grid-cols-1 grid-rows-auto gap-4 min-[850px]:max-w-[766px] min-[850px]:grid-cols-2 xl:max-w-[1152px] xl:grid-cols-3">
            {
