...
export default function Error() {
  return (
    <main className="w-full h-screen flex gap-3 justify-center items-center">
      <svg
      ...
      <div className="text-white flex flex-col gap-2">
        ...
        <Link to="/" className="w-fit transition-all duration-300 text-[14px] border border-white py-1 px-2 inline-flex gap-1 items-center rounded-xl active:scale-90 hover:text-primary hover:border-primary">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
